...
docker-compose -f docker-compose.yml up -d ca.example.com orderer.example.com peer0.org1.example.com couchdb peer0.org2.example.com peer0.org3.example.com cli
docker ps -a
